...
`/phonetics` 页面会先播放独立音素，随后使用浏览器语音朗读卡片上的示例单词。元音按需使用 [Wikimedia Commons](https://commons.wikimedia.org/) 的开放许可真人 IPA 示例（官方 MP3 转码）；辅音使用项目内原有的本地独立短音，避免 Commons 辅音录音中的载体元音。不需要云服务账号、密钥或银行卡。
...
pubDate: 2025-04-30
tags: ["Shader", "URP"]
category: shader     # 必须是: shader | math | optimize | tools
